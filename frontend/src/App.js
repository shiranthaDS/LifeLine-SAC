      ...
      <div className="nav-brand">
        <Link to="/" className="nav-logo">
          ...
          <div className="nav-links-center">
            <Link to="/courses" className="nav-link nav-link-primary">
              <span>Learn</span>
            </Link>
            <Link to="/challenges" className="nav-link nav-link-primary">
              <span>Challenges</span>
            </Link>
            <Link to="/exam" className="nav-link nav-link-primary">
              <span>Exam</span>
            </Link>
